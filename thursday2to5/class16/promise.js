        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prepareTea("add water", 0)];
                case 1:
                    step1 = _a.sent();
                    return [4 /*yield*/, prepareTea("add tea leaves", 5000)];
                case 2:
                    step2 = _a.sent();
                    throw new Error("Error");
                case 3:
                    step3 = _a.sent();
                    return [4 /*yield*/, prepareTea("add sugar", 2000)];
                case 4:
                    step4 = _a.sent();
                    return [4 /*yield*/, prepareTea("tea is ready", 0)];
                case 5:
                    step5 = _a.sent();
                    return [3 /*break*/, 8];
                case 6:
